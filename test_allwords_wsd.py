...
xtra_wordz = ['the', 'quick', 'brown', 'fox']
for sentence in brown.sents()[:10]:
    # Retrieves a tokenized text from brown corpus.
    sentence = " ".join(sentence)
    # Annotate the full sentence.
    print disambiguate_new(sentence, simple_lesk, xtra_wordz, prefersNone=True, keepLemmas=True)
    print disambiguate_new(sentence, original_lesk, xtra_wordz)
    print disambiguate_new(sentence, adapted_lesk, xtra_wordz, keepLemmas=True)
    print disambiguate_new(sentence, cosine_lesk, xtra_wordz, prefersNone=True)
    print
print
...
for sentence in brown.sents()[0:1]:
    ...
    sentence = " ".join(sentence)
    # Annotate the full sentence.
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='path')
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='wup')
print
...
for sentence in brown.sents()[0:1]:
    ...
    sentence = " ".join(sentence)
    # Annotate the full sentence.
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='lch')
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='res')
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='jcn')
    print disambiguate_new(sentence, max_similarity, xtra_wordz, similarity_option='lin')
...
>>> disambiguate_new('I went to the bank to deposit my money')
...
>>> disambiguate_new('I went to the bank to deposit my money', prefersNone=True, keepLemmas=True)
...
>>> disambiguate_new('I went to the bank to deposit my money', algorithm=cosine_lesk, prefersNone=True)
...
>>> disambiguate_new('I went to the bank to deposit my money', algorithm=maxsim, similarity_option='wup', prefersNone=True)
